         ...
         <div class="container">
            ...
            <div class="row">
                ...
                <div id="sorry123" style="visibilty:hidden"> <center> <h2 style="color: #4EAE4D">Sorry :( No items found!</h2></center>
                  ...
                  <center> <a href="home.html" style="color: black;text-decoration: underline">See our other categories</a></center></div>
            ...
            <script>
                ...
                window.onload = function() {
                    var ch = document.getElementById("t11").textContent;
                    document.getElementById("t12").value = ch;
